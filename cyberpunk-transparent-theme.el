;;; cyberpunk-transparent-theme.el --- Cyberpunk Color Theme
...
;; Keywords: color theme cyberpunk transparent
;; Version: 1.17.1
...
(deftheme cyberpunk-transparent "The Cyberpunk (Transparent) color theme")
...
x      (cyberpunk-magenta "#dc8cc3")
 ...
 (custom-theme-set-faces
   ...
   `(buffers-tab ((,class (:background ,cyberpunk-tr :foreground ,cyberpunk-white-2))))

   ;;; basic coloring
   `(default ((,class (:foreground ,cyberpunk-gray :background ,cyberpunk-tr))))
   ...
   `(menu ((,class (:foreground ,cyberpunk-blue-5 :background ,cyberpunk-gray-5))))
   `(minibuffer-prompt ((,class (:foreground ,cyberpunk-green+1 :background ,cyberpunk-tr))))
   `(mode-line
   ...
   `(mode-line-inactive
     ((,class (:foreground ,cyberpunk-gray-7
                           ...
                           :box (:line-width -1 :color ,cyberpunk-blue-5)))))
   `(region ((,class (:background ,cyberpunk-yellow-3))))
...
(provide-theme 'cyberpunk-transparent)
